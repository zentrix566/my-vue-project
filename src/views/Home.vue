  ...
  <div class="home">
    ...
    <div class="cards">
      ...
      <RouterLink class="card" to="/biography">
        <div class="emoji">📖</div>
        <h2>人物生平 · 纪年查询</h2>
        <p>输入历史人物姓名，输出姓名（生卒年）、主要事迹及当时年纪、死亡原因与享年，由大模型整理年谱。</p>
      </RouterLink>
      ...
      <RouterLink class="card" to="/career-roles">
        <div class="emoji">🏛️</div>
        <h2>现代职业 · 古代岗位</h2>
        <p>看看公务员、收银员、流水线工人在古代叫什么；也能输入任意现代行业，让 AI 推想对应的古代职业。</p>
      </RouterLink>
      ...
      <RouterLink class="card" to="/secure-storage">
        <div class="emoji">🔐</div>
        <h2>端到端加密 · 云端密文存储</h2>
        <p>本地用 ECIES 加密后再上云，云端只存密文；私钥本机保存，没有密钥连管理员也解不开你存了什么。</p>
      </RouterLink>
      ...
      <RouterLink class="card" to="/interval-training">
        <div class="emoji">🏃</div>
        <h2>400 米间歇训练</h2>
      ...
      <RouterLink class="card" to="/countdown">
        <div class="emoji">⏳</div>
        <h2>人生倒计时</h2>
        <p>输入出生日期与性别，一屏看距 35 岁斩杀线、退休与预期寿命还剩多久，还能自定义一个目标节点倒计时。</p>
      </RouterLink>
    </div>
  </div>
</template>
